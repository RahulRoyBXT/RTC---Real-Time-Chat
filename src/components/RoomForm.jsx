  ...
  setCurrentRoom: PropTypes.func.isRequired,
    ...
    return (
        <div className="w-full h-full flex flex-wrap p-6 gap-5 items-center justify-center">
            ...
            {/* for vc */}
            <div className="w-[22rem] h-[22rem] mr-5 flex flex-col justify-center items-center gap-2 bg-slate-400 rounded-xl">
                <h3 className="font-bold text-2xl font-mono text-center">Enter Room ID <span className="sm:hidden"><br/></span> to<span className="max-sm:text-3xl max-sm:font-black"> Join</span><span className="sm:hidden"><br/></span><span className="max-sm:text-3xl max-sm:font-black">Video Call</span></h3>
                <br />
                ...
                <button onClick={handleJoinVC} className="p-4 bg-blue-800 text-white rounded-lg font-semibold">
                    Enter Call
                </button>
            </div>
